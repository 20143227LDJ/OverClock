...
<div class="pic_lt">
    ...
    ?>
            ...
            <span class="lt_date text-center" style="text-align:center"> <?php if ($list[$i]['icon_secret']) echo "<i class=\"fa fa-lock\" aria-hidden=\"true\"></i><span class=\"sound_only\">비밀글</span> ";
            ...
            <?php if ($list[$i]['comment_cnt'])  echo "<span class=\"lt_cmt\">+ ".$list[$i]['wr_comment']."</span>"; ?>
            </span>
